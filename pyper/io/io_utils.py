...
def extract_data_from_frame_continuous(frame):
    start_index = 28
    frames = intlist_to_int(frame[1][12 : 12 + 4])
    n_sensors = frame[1][20 : 20 + 4]
    ...
    for i in range(n_sensors[0]):
        ...
        in_list.append(int(i + 1))
        in_list.append(int(frames))
        in_list.append(frame[0])  # this is the timestamp
        in_list.append(intlist_to_float(frame[1][start_index : start_index + 4]))
        in_list.append(intlist_to_float(frame[1][start_index + 4 : start_index + 8]))
        in_list.append(intlist_to_float(frame[1][start_index + 8 : start_index + 12]))
        in_list.append(intlist_to_float(frame[1][start_index + 12 : start_index + 16]))
        in_list.append(intlist_to_float(frame[1][start_index + 16 : start_index + 20]))
        in_list.append(intlist_to_float(frame[1][start_index + 20 : start_index + 24]))
